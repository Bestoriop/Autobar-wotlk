...
if (GetLocale() == "deDE") then
	AutoBar.locale = {
		...
		["AutoBarButtonCooldownStoneCombat"] = "Stein Abklingzeit: Kampf",
		...
		["AutoBarButtonSpell1"] = "Zauber 1",
		["AutoBarButtonSpell2"] = "Zauber 2",
		["AutoBarButtonSpell3"] = "Zauber 3",
		["AutoBarButtonSpell4"] = "Zauber 4",
		...
		["Consumable.Cooldown.Stone.Combat"] = "Abklingzeit: Steine - Kampf",
